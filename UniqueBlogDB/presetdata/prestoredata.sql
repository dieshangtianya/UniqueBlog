...
declare @categoryId int,
        @blogId int;
select @blogId=(select top 1 BlogId from t_blog);
select @categoryId =(select categoryId from t_category where CategoryName='ASP.NET MVC');

INSERT INTO t_blog_post(BlogId,CategoryId,PostTitle) values (@blogId,@categoryId,'Asp.net MVC 分部视图');
INSERT INTO t_blog_post(BlogId,CategoryId,PostTitle) values (@blogId,@categoryId,'Asp.net MVC 路由机制');
INSERT INTO t_blog_post(BlogId,CategoryId,PostTitle) values (@blogId,@categoryId,'Asp.net MVC 模型处理');
INSERT INTO t_blog_post(BlogId,CategoryId,PostTitle) values (@blogId,@categoryId,'Asp.net MVC 客户端验证');
INSERT INTO t_blog_post(BlogId,CategoryId,PostTitle) values (@blogId,@categoryId,'Asp.net MVC 服务器验证');
INSERT INTO t_blog_post(BlogId,CategoryId,PostTitle) values (@blogId,@categoryId,'Asp.net MVC 部署');
INSERT INTO t_blog_post(BlogId,CategoryId,PostTitle) values (@blogId,@categoryId,'Asp.net MVC 分部视图');
INSERT INTO t_blog_post(BlogId,CategoryId,PostTitle) values (@blogId,@categoryId,'Asp.net MVC 分部视图');
INSERT INTO t_blog_post(BlogId,CategoryId,PostTitle) values (@blogId,@categoryId,'Asp.net MVC 分部视图');
INSERT INTO t_blog_post(BlogId,CategoryId,PostTitle) values (@blogId,@categoryId,'Asp.net MVC 分部视图');
